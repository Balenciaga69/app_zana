...
import { type SignalREvent, SignalREvents } from './SignalREvents'

type EventCallback = (payload: any) => void

class SignalRServiceV2 {
  // 單例實例
  private static instance: SignalRServiceV2
  // SignalR 連接實例
  ...
  // 取得單例實例
  public static getInstance(): SignalRServiceV2 {
    if (!SignalRServiceV2.instance) {
      SignalRServiceV2.instance = new SignalRServiceV2()
    }
    return SignalRServiceV2.instance
  }
...
export default SignalRServiceV2
